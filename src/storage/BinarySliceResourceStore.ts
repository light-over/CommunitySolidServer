 ...
 *
 * In case the slice happens, unit/start/end values will be written to the metadata to indicate so.
...
export class BinarySliceResourceStore<T extends ResourceStore = ResourceStore> extends PassthroughStore<T> {
  ...
  public async getRepresentation(identifier: ResourceIdentifier, preferences: RepresentationPreferences,
    ...
    try {
      ...
      // is because `guardedStreamFrom` does not create object streams when inputting streams/buffers.
